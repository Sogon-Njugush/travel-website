...
const Hero = () => {
  return (
   <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
    ...
    <h1 className='bold-52 lg:bold-88'>Naivasha Tent Camp Area</h1>
    <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>
    Naivasha Tent Camp is a serene retreat nestled in the heart of Kenya's Great Rift Valley. 
    Surrounded by lush acacia trees and vibrant wildlife,
    the camp offers a unique blend of rustic charm and modern comfort
    </p>
    ...
    <div className='relative  flex flex-1 items-start'>
        <div className='relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
            ...
            <div className='flex  flex-col'>
                ...
                <p className='bold-20 text-white'>Heavens Gate</p>
                </div>

                <div className='flexBetween'>
                   <div className='flex flex-col'>
                    <p className='regular-16 block text-gray-20'>Distance</p>
                    <p className='bold-20 text-white'>175.28 km</p>
                   </div>
                   <div className='flex flex-col'>
